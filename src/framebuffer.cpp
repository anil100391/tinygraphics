...
tgrFrameBuffer::tgrFrameBuffer()
{
    ...
    glTexImage2D(
        GL_TEXTURE_2D, 0, GL_RGB, w, h, 0, GL_RGB, GL_UNSIGNED_BYTE, nullptr );
    ...
    // create a depth and stencil attachement. choosing a single renderbuffer
    // for both of it
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void tgrFrameBuffer::Bind() const
{
    glBindFramebuffer( GL_FRAMEBUFFER, _frameBufferId );
}
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void tgrFrameBuffer::Unbind() const
{
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void tgrFrameBuffer::BindTexture() const
{
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void tgrFrameBuffer::UnbindTexture() const
{
