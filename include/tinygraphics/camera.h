...
public:
    ...
    GetProjectionMatrix( float aspectRatio, float zNear, float zFar ) noexcept
    {
        ...
        return glm::perspective( _fov, aspectRatio, zNear, zFar );
    }

    void OnEvent( tgrEvent &evt );
